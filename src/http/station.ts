...
export class Station extends TypedEmitter<StationEvents> {
    ...
    public stopLivestream(device: Device): void {
        ...
        // ---- SOLO / E40 / Floodlight 842x / Wired doorbell families ----
        if (
            ...
            rootHTTPLogger.debug("SoloCam/E40 stop livestream - sending CMD_DOORBELL_SET_PAYLOAD (END_LIVESTREAM)", {
            ...
            this.p2pSession.sendCommandWithStringPayload(
                {
                    commandType: CommandType.CMD_DOORBELL_SET_PAYLOAD, // 1700
                    value: JSON.stringify({
                        commandType: ParamType.COMMAND_END_LIVESTREAM, // 1050
                        data: {}
                    }),
                    channel: device.getChannel()
                },
